...
try:
    ...
    print(Fore.RED + 'WKHTMLTOPDF was not found in program root directory. Download and install it in your program folder and retry scan' + Style.RESET_ALL)
    ...
    if ask_whktmltopdf_install == 'Y':
        print(Fore.GREEN + 'Opening WKHTMLTOPDF page in your browser. Program will be closed' + Style.RESET_ALL)
...
try:
    ...
    print(Fore.RED + 'Main config file was not found in program root directory.' + Style.RESET_ALL)
    sys.exit()
